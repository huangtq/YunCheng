...
public class YcHotelRoom extends BaseEntity {
    ...
    private String delFlag; private Integer reservedStock; private String hotelName;
    ...
    public Integer getReservedStock(){return reservedStock;} public void setReservedStock(Integer v){reservedStock=v;}
