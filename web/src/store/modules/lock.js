...
export const useLockStore = defineStore('lock', {
  state: () => ({
    ...
    lockPath: localStorage.getItem(LOCK_PATH_KEY) || '/meeting/activity'
  }),
  actions: {
    // 锁定屏幕，同时记录当前路径
    lockScreen(currentPath) {
      this.lockPath = currentPath || '/meeting/activity'
    ...
    unlockScreen() {
      ...
      this.lockPath = '/meeting/activity'
      localStorage.setItem(LOCK_PATH_KEY, '/meeting/activity')
    }
  }
})
